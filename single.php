							...
							<div style="" class="tab-pane fade" id="mini-three">
								...
								<?php
								 ...
								 ?>
									...
									<?php
										if(isset($_SESSION['customer']) && !empty($_SESSION['customer'])){
											echo '<h4 class="uppercase space35">'.$revcountr["count"].' Reviews for '.substr($prodr['name'], 0, 20).'</h4>';
										}
										else
										{
											echo "<center><h3>Please <a href='login.php'>Login</a> To Continue</h3></center>";
										}
									?>
									 ...
									 ?>
										<div class="row">
											<div class="col-md-6 space20">
												<input name="name" class="input-md form-control" placeholder="Name *" maxlength="100" required="" type="text" value="<?php echo $userr['firstname'] . " " . $userr['lastname'];?>" >
											</div>
											<div class="col-md-6 space20">
												<input name="email" class="input-md form-control" placeholder="Email *" maxlength="100" required="" type="email" value="<?php echo $userr['email']; ?>" >
											</div>
										</div>
